...
(() => {
  ...
  const onButtonClick = () => setVisibility(!isOpen);
  ...
  (async () => {
    try {
      ...
      if (el) {
        ...
        try {
          if (window.__extTextColorForBg) el.style.color = __extTextColorForBg(newHexColor);
        } catch {}
      }
        ...
        editItem.addEventListener('click', async (e) => {
          ...
          try {
            ...
            try {
              ...
              try { tagEl.style.color = __extTextColorForBg(hex); } catch {}
            } catch {}
          } catch (err) {
          }
        });
